            ...
            <div class="collapse navbar-collapse pt-3 pb-2 py-lg-0 w-100" id="navigation">
              <ul class="navbar-nav navbar-nav-hover ms-auto">
                <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="{{ route('pemberitahuan')}}">
                ...
                <li class="nav-item ms-lg-auto">
                  <a class="nav-link nav-link-icon me-2" href="{{ route('profile')}}">
                    <p class="d-inline text-sm z-index-1 font-weight-bold" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Akun Saya">Profile</p>
                  </a>
                </li>
                <li class="nav-item my-auto ms-3 ms-lg-0">
                  <a href="{{ route('logout')}}" class="btn btn-sm  bg-gradient-primary  mb-0 me-1 mt-2 mt-md-0">Keluar</a>
                </li>
              </ul>
            </div>
          </div>
